...
object GuestLibraries {
     ...
     *
     * **a named test rather than a count of files.** a count answers the wrong question: a threshold
     * of twenty out of the twenty-eight is satisfied by twenty-seven, which is the same class of
     * mistake as reading "the folder is already there" as "the right bytes are there". these two are
     * what a staged set is asserted on when it is written, so they are what it is recognised by here.
     */
