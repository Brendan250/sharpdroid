...
object Theme {
    ...
    private fun style(chosen: String): Int = when (chosen) {
        Settings.THEME_LIGHT -> R.style.Theme_SharpEmu_Light
        Settings.THEME_DARK -> R.style.Theme_SharpEmu_Dark
        Settings.THEME_MATERIAL_YOU, Settings.THEME_CUSTOM -> R.style.Theme_SharpEmu
