...
- **the app's own licence is one of these documents.** sharpdroid is GPL-2.0-or-later and the GPL text already ships beside the guest libraries, so the About screen's *Read it* link opens that one rather than a second copy of it.
